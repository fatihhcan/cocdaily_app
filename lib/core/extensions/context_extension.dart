...
import '../constants/init/theme/light/color_theme.dart';
...
extension PaddingExtensionSymmetric on BuildContext {
  ...
  EdgeInsets get paddingLowOnly => EdgeInsets.only(left: lowValue, bottom: lowValue, top: normalValue*2, right: lowValue);
}
